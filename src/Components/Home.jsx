    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <NavLink
            to={"/SubCategories/HomeConstruction"}
            className="p-4 md:w-1/2 lg:w-1/3"
          >
            <div className="flex rounded-lg h-full bg-white shadow-lg border green p-8 flex-col">
              <div className="flex items-center mb-3">
          ...
          >
            <div className="flex rounded-lg h-full bg-white shadow-lg border green p-8 flex-col">
              ...
              <div className="flex-grow">
                <p className="leading-relaxed text-gray-700">
                  Subcategories: Buy Stall, Advance Rent for Shop, Shop Assets,
                  Shop Machinery
                  <br />
                  Maximum Loan: PKR 10 Lakh
                  <br />
      ...
      <div className="flex justify-end mt-0.5 sticky bottom-4 top-4">
        <div className=" border-2 border-amber-900 p-1.5 w-8 rounded-2xl shadow-2xl">
          <FaCalculator className="flex justify-center align-middle" />
        </div>
      </div>
      </NavLink>
    </section>
